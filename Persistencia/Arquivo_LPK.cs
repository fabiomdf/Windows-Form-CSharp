...
{    
    public class Arquivo_LPK
    {
        ...
        public Arquivo_LPK(ResourceManager rm, String nome) 
        {
            //this.versao = 3;
            this.nome = nome;
            this.rm = rm;
        ...
        public Arquivo_LPK(ResourceManager rm)
        {
            //this.versao = 3;
        ...
        public bool RestaurarVersao(string arquivoNome)
        {
            ...
            Arquivo_LPK_V05 LPKRestaurado = new Arquivo_LPK_V05(this.rm);
            ...
            this.texto.Add(rm.GetString("TEXTO_112_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
