...
{
    public class Arquivo_FIX_V05 //: IArquivo
    {
        ...
        public unsafe struct FormatoParametrosFixos
        {
            ...
            public Byte reservado; // baudrate = 0, para 115200 e  baudrate = 1, para 57600
            ...
            public fixed Byte reservado5[2]; // Tempo para animação se faltar comunicação (t=0 -> Caso não faça animação)
        ...
        public Arquivo_FIX_V05(Arquivo_FIX_V05 oldValue)
        {
