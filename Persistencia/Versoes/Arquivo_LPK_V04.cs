...
namespace Persistencia
{
    public class Arquivo_LPK_V04
    {
        ...
        public Arquivo_LPK_V04(ResourceManager rm, String nome)
        {
            //this.versao = 3;
            this.nome = nome;
            this.rm = rm;
        ...
        public Arquivo_LPK_V04(ResourceManager rm)
        {
            //this.versao = 3;
        ...
        public bool RestaurarVersao(string arquivoNome)
        {
            ...
            Arquivo_LPK_V03 LPKRestaurado = new Arquivo_LPK_V03(this.rm);
            ...
            //adicionando as novas informações da versao 3 para a versão 4
            this.texto.Add(rm.GetString("TEXTO_104_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
            this.texto.Add(rm.GetString("TEXTO_105_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
            this.texto.Add(rm.GetString("TEXTO_106_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
            this.texto.Add(rm.GetString("TEXTO_107_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
