...
{    
    public class Arquivo_LPK_V03
    {
        ...
        public Arquivo_LPK_V03(ResourceManager rm, String nome) 
        {
            //this.versao = 3;
            this.nome = nome;
            this.rm = rm;
        ...
        public Arquivo_LPK_V03(ResourceManager rm)
        {
            //this.versao = 3;
        ...
        public void RestaurarVersao(string arquivoNome)
        {
            // A versão 3 é a inicial de nosso controle, por isso apenas abre e carrega o objeto
