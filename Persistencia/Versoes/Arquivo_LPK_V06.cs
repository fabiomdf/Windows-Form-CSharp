...
namespace Persistencia
{
    public class Arquivo_LPK_V06
    {
        ...
        public Arquivo_LPK_V06(ResourceManager rm, String nome)
        {
            //this.versao = 3;
            this.nome = nome;
            this.rm = rm;
        ...
        public Arquivo_LPK_V06(ResourceManager rm)
        {
            //this.versao = 3;
        ...
        public bool RestaurarVersao(string arquivoNome)
        {
            ...
            Arquivo_LPK_V06 LPKRestaurado = new Arquivo_LPK_V06(this.rm);
            ...
            //adicionando as novas informações da versao 5 para a versão 6
            this.texto.Add(rm.GetString("TEXTO_109_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
            this.texto.Add(rm.GetString("TEXTO_110_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
            this.texto.Add(rm.GetString("TEXTO_111_ARQUIVO_LPK").PadRight(TAM_MAX_FRASE, '\0'));
