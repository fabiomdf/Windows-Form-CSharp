...
{
    public partial class NumeroTextoTriplo : UserControl
    {
        Fachada fachada = Fachada.Instance;
        String mensagemErro = String.Empty;

        public NumeroTextoTriplo()
        {
            InitializeComponent();
            AplicaIdioma();
        }
        ...
        private void NumeroTextoTriplo_Load(object sender, EventArgs e)
        {
            rtbNumero.SelectionAlignment = HorizontalAlignment.Center;
            rtbTexto01.SelectionAlignment = HorizontalAlignment.Center;
            rtbTexto02.SelectionAlignment = HorizontalAlignment.Center;
        ...
        public void CarregarTextos(string numero, string texto1, string texto2, string texto3)
        {
