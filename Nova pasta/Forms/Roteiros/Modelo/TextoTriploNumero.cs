...
{
    public partial class TextoTriploNumero : UserControl
    {
        Fachada fachada = Fachada.Instance;
        String mensagemErro = String.Empty;

        public TextoTriploNumero()
        {
            InitializeComponent();
            AplicaIdioma();
        }
        ...
        private void AplicaIdioma()
        {
            ...
            this.rtbNumero.Text = rm.GetString("USER_CONTROL_MODELOS_TEXTO_04");
        ...
        private void rtbTexto03_TextChanged(object sender, EventArgs e)
        {
            if (((RichTextBox)sender).ContainsFocus)
            {
                ((TextosEditor)Parent.Parent.Parent).SetTextoSelecionado(3, rtbTexto03.Text, false);
        ...
        {
            ((TextosEditor)Parent.Parent.Parent).SetTextoSelecionado(3, rtbTexto03.Text, true);
        }
        ...
        private void TextoTriploNumero_Load(object sender, EventArgs e)
        {
            rtbNumero.SelectionAlignment = HorizontalAlignment.Center;
            rtbTexto01.SelectionAlignment = HorizontalAlignment.Center;
            rtbTexto02.SelectionAlignment = HorizontalAlignment.Center;
        ...
        public void CarregarTextos(string texto1, string numero, string texto2, string texto3)
        {
