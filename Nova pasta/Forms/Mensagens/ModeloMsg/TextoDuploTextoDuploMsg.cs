...
{
    public partial class TextoDuploTextoDuploMsg : UserControl
    {
        Fachada fachada = Fachada.Instance;

        String mensagemErro = String.Empty;

        public TextoDuploTextoDuploMsg()
        {
            InitializeComponent();
            AplicaIdioma();
        }
        ...
        private void rtbTexto03_TextChanged(object sender, EventArgs e)
        {
            if (((RichTextBox)sender).ContainsFocus)
            {
                ((TextosEditorMsg)Parent.Parent.Parent).SetTextoSelecionado(1, rtbTexto03.Text, false);
        ...
        private void rtbTexto02_TextChanged(object sender, EventArgs e)
        {
            if (((RichTextBox)sender).ContainsFocus)
            {
                ((TextosEditorMsg)Parent.Parent.Parent).SetTextoSelecionado(2, rtbTexto02.Text, false);
        ...
        private void rtbTexto04_TextChanged(object sender, EventArgs e)
        {
            if (((RichTextBox)sender).ContainsFocus)
            {
                ((TextosEditorMsg)Parent.Parent.Parent).SetTextoSelecionado(3, rtbTexto04.Text, false);
        ...
        {
            ((TextosEditorMsg)Parent.Parent.Parent).SetTextoSelecionado(1, rtbTexto03.Text, true);
        }

        private void rtbTexto02_Enter(object sender, EventArgs e)
        {
            ((TextosEditorMsg)Parent.Parent.Parent).SetTextoSelecionado(2, rtbTexto02.Text, true);
        }

        private void rtbTexto04_Enter(object sender, EventArgs e)
        {
            ((TextosEditorMsg)Parent.Parent.Parent).SetTextoSelecionado(3, rtbTexto04.Text, true);
        }

        private void TextoDuploTextoDuploMsg_Load(object sender, EventArgs e)
        {
            rtbTexto01.SelectionAlignment = HorizontalAlignment.Center;
            rtbTexto02.SelectionAlignment = HorizontalAlignment.Center;
            rtbTexto03.SelectionAlignment = HorizontalAlignment.Center;
